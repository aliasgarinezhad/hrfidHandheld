...
import com.jeanwest.reader.checkIn.stockDraftProperties
import com.jeanwest.reader.checkIn.stockDraftProducts
...
class WarehouseCheckInActivityTest {

@get:Rule
val activity = createAndroidComposeRule<CentralWarehouseCheckInActivity>()
